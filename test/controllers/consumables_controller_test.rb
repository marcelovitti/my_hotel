...
class ConsumablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consumable" do
    assert_difference('Consumable.count') do
      post consumables_url, params: { consumable: { name: @consumable.name, price: @consumable.price } }
    end
  ...
  test "should update consumable" do
    patch consumable_url(@consumable), params: { consumable: { name: @consumable.name, price: @consumable.price } }
